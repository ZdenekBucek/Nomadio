...
export default async function DayPage({params,searchParams}:Props){
  ...
  const message=query.item?messages[query.item as keyof typeof messages]??messages.error:null; const success=["created","updated","moved","removed","place-added"].includes(query.item??"");
