import { AlertTriangle, BedDouble, CalendarDays, Coffee, CreditCard, MapPin, Users } from "lucide-react";
...
export function AccommodationList({ items, trip }: { items: AccommodationWithPlace[]; trip: TripRow }) {
