...
export function AppShell({ activeTrips = [], children, profile }: AppShellProps) {
  return (
    <div className="relative min-h-dvh lg:grid lg:grid-cols-[17rem_minmax(0,1fr)]">
      ...
      <div className="min-w-0 pb-[var(--mobile-content-bottom-padding)] lg:pb-0">
      ...
      <div className="fixed inset-x-3 bottom-[var(--mobile-bottom-nav-bottom)] z-30 rounded-2xl border border-border bg-sidebar/90 p-1.5 shadow-[0_18px_50px_-20px_rgba(0,0,0,0.95)] backdrop-blur-2xl lg:hidden">
